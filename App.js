    ...
    <View style={styles.container}>
      <View style={styles.card}>
        <Image
          ...
          source={{
            uri:
              "https://img.global.news.samsung.com/br/wp-content/uploads/2021/02/S21.jpg",
          }}
        />

        <View style={styles.productInfo}>
          <Text style={{ fontWeight: "bold" }}>
            Smartphone Samsung Galaxy S21 5G Cinza 128GB, 8GB RAM, Tela Infinita
            de 6.2”, Câmera Traseira Tripla, Android 11 e Processador Octa-Core
          </Text>
          <Text>
      ...
      <View style={styles.orderButtons}>
        <TouchableHighlight style={styles.finishButton} onPress={focusOrder}>
          <Text
            style={{
              fontSize: 12,
              color: "#fff",
        ...
        <TouchableHighlight style={styles.orderButton} ref={finishOrder}>
          ...
          >
            {" "}
            <Feather name={"shopping-cart"} size={15} /> REALIZAR PEDIDO
          </Text>
        </TouchableHighlight>
      </View>
    </View>
